    ...
    <div className="absolute inset-0 flex items-center justify-center p-6">
      ...
      >
        ...
        <div className="h-8 border-b border-neutral-800 flex items-center px-4 gap-6 bg-neutral-900/40">
          ...
          <div className="text-[10px] text-neutral-500 font-medium pb-px">
            API Reference
          </div>
        </div>
          ...
          <div className="w-[120px] border-r border-neutral-800 p-3 space-y-4 bg-neutral-900/20">
            <div className="space-y-2.5">
              {[
                ...
                <div
                  key={i}
                  className={`flex items-center gap-2 ${item.active ? "text-emerald-400" : "text-neutral-500"}`}
                >
            ...
            <div className="pt-2 border-t border-neutral-800 space-y-2">
              <div className="text-[9px] font-semibold text-neutral-500 px-1 mb-1">
                Get Started
              </div>
      ...
      >
        ...
        <div className="w-1/2 h-full border-r border-neutral-800 bg-neutral-900/60 p-3 pt-4 font-mono text-[9px] leading-relaxed relative">
          ...
          <div className="mt-6 space-y-1">
            <div className="flex gap-2">
              <span className="text-neutral-600 select-none w-2 text-right">
                1
              </span>
              <div>
                <span className="text-emerald-400">##</span>{" "}
                <span className="text-teal-300">Setting up</span>
              </div>
            </div>
            <div className="flex gap-2">
              <span className="text-neutral-600 select-none w-2 text-right">
            ...
            <div className="flex gap-2 text-emerald-100">
              ...
              <div className="flex">
                ...
                <motion.span
                  ...
                  className="w-[1px] h-[10px] bg-emerald-400 ml-[1px] inline-block"
                />
              </div>
            </div>
            <div className="flex gap-2">
            ...
            <div className="flex gap-2">
              ...
              <div>
                <span className="text-teal-400">&lt;CardGroup</span>{" "}
                <span className="text-emerald-300">cols</span>=
            ...
            <div className="flex gap-2">
              ...
              <div className="pl-8">
                ...
                <span className="text-neutral-400">"Edit Your Docs"</span>
              </div>
            </div>
            <div className="flex gap-2">
              <span className="text-neutral-600 select-none w-2 text-right">
              ...
              <div className="pl-8">
                ...
                <span className="text-neutral-400">"pen-to-square"</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-1/2 h-full bg-[#0a0a0a] relative">
          <div className="flex items-center justify-center gap-1.5 absolute top-0 left-0 w-full h-8 border-b border-neutral-800 bg-neutral-900/40">
            ...
            <span className="text-neutral-300 text-[10px] font-medium">
              Quickstart
            </span>
          </div>
          ...
          >
            ...
            <p className="text-neutral-400 text-[9px] mb-4 leading-relaxed">
              Learn how to document your code effectively to support your deve
              <motion.span
                animate={{ opacity: [1, 0, 1] }}
                transition={{ duration: 0.8, repeat: Infinity }}
                className="w-px h-2 bg-emerald-400 ml-px inline-block align-middle"
              />
            </p>
            ...
            >
              ...
              <div className="text-neutral-500 text-[8px] leading-relaxed">
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center overflow-hidden">
      ...
      >
        <svg
          viewBox="0 0 24 24"
          className="w-20 h-20 text-white drop-shadow-[0_0_20px_rgba(255,255,255,0.4)]"
          fill="currentColor"
        >
          <motion.path
...
function StackGraphic() {
  const items = [
    ...
    {
      title: "Standardized Formatting Across Docs",
      time: "3 months ago by Josh",
    },
...
function FeatureCard({
  ...
  return (
    <div
      className={`flex flex-col rounded-2xl border border-neutral-800/80 bg-transparent overflow-hidden relative group ${className}`}
    >
      {/* Graphic Container */}
