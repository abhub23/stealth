      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          <motion.div
            ...
            className="lg:col-span-2 lg:row-span-2 border border-neutral-800 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow overflow-hidden relative"
          >
              ...
              <div className="flex items-center justify-between mb-8">
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Comprehensive analytics across 6 months
                  </p>
                </div>
                <motion.div
                  animate={{ rotate: 360 }}
          ...
          <motion.div
            ...
            className="border border-neutral-800 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow relative overflow-hidden"
          >
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-8">
                <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <div className="relative z-10">
              ...
              <p className="text-xs text-indigo-400 font-bold mt-6 text-center">
                ✓ 100% SECURE
              </p>
            </div>
          </motion.div>
